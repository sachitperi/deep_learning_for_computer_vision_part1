...
# initialize the url that contains the captcha images that we will be downloading thus far
...
for i in range(0, args["num_images"]):
    ...
    # handel if any exceptions are thrown during the download process
    except:
